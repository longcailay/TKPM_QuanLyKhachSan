...
public class CapNhatNguoiDung extends JFrame {
	...
	private int idNguoiDung = wsNhanVien.nguoiDung.getId();
	private JTextField txtHoTen = new JTextField(wsNhanVien.nguoiDung.getHoTen());
	private JTextField txtCMND = new JTextField(wsNhanVien.nguoiDung.getCmnd());
	private JTextField txtSDT = new JTextField(wsNhanVien.nguoiDung.getSdt());
	private JTextField txtDiaChi = new JTextField(wsNhanVien.nguoiDung.getDiaChi());
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CapNhatNguoiDung frame = new CapNhatNguoiDung();
	...
	public CapNhatNguoiDung() {
		...
		setResizable(false);
		setTitle("HoApp - Cập nhật người dùng");
		...
		JLabel lblNewLabel = new JLabel("C\u1EADp nh\u1EADt th\u00F4ng tin nh\u00E2n vi\u00EAn");
		...
		btnCapNhat.setFont(new Font("Tahoma", Font.PLAIN, 24));
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_contentPane.createSequentialGroup()
									.addComponent(btnCapNhat, GroupLayout.PREFERRED_SIZE, 134, GroupLayout.PREFERRED_SIZE)
									.addGap(100)
	 ...
	 void loadCMBPhanQuyen() {
		 ...
		 cmbPhanQuyen.setSelectedItem(wsNhanVien.phanQuyen);
	 }
	 
	 void btnCapNhatClick() {
		 int temp = NguoiDungBUS.CapNhatNguoiDung(idNguoiDung, txtHoTen.getText(),txtCMND.getText(),txtSDT.getText(),txtDiaChi.getText(),txtTaiKhoan.getText(),txtMatKhau.getText(),cmbPhanQuyen.getSelectedItem().toString());
		 if(temp == 1) {
